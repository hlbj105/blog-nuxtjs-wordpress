  ...
  <div class="comments-wrap">
    ...
    <div v-else-if="commentStatus === 'open'" class="comment-from">
      ...
      <div class="comment-other">
        ...
        <upload
          v-show="showChart"
          @showChart="_getShowChart"
          @updateContent="_getContent"
          :showChart="showChart"
        ></upload>
        <!-- 表情 -->
      ...
      <div class="box">
        ...
        <div class="comment-inp comment-from-url">
          ...
          <input type="url" id="url" name="url" autocomplete="off" v-model="url.value" />
        </div>
    ...
    <ul class="comment-list-wrap">
      <li class="comment-list" v-for="(item, index) in commentList" :key="item.key">
        ...
        <div class="list-header">
          ...
          ></span>
          <img
            v-if="item.userAgentInfo.vipStyle.title === '博主'"
          ...
          <p class="inline-block system-wrap">
            ...
            <span
              class="system-info"
            >{{ item.userAgent.systemName }} {{ item.userAgent.systemVersion }}</span>
          </p>
        ...
        <div class="list-footer">
          ...
          <div class="opinion">
            <span class="opinion-btn" @click="_updateCommentOpinion(item.id, 'good', index)">
              ...
              {{ item.meta.opinion.good }}
            </span>
            <span class="opinion-btn" @click="_updateCommentOpinion(item.id, 'bad', index)">
              <x-icon type="icon-bad"></x-icon>
              {{ item.meta.opinion.bad }}
            </span>
          </div>
        </div>
    ...
    <div class="more-btn" @click="bClick && _getMoreList()">
      <span>
        <i v-show="bMoreList" class="iconfont icon-loading"></i>
        {{ sMoreBtnText }}
      </span>
    </div>
  </div>
